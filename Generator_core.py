...
اطلاعاتی که به عنوان فایل ورودی بهت دادم سعی کن دقیقا از اون اطلاعات موجود در اون فایل استفاده کنی و هر اطلاعات مرتبطی رو که از contenct گرفتی بهش حتما اشاره کن 
